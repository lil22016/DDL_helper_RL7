const CACHE='deadline-garden-v16-26-wardrobe-calendar-mobile';
const ASSETS=['./','./index.html','./styles.css?v=1626','./app.js?v=1626','./manifest.webmanifest','./favicon.ico?v=1612','./apple-touch-icon.png?v=1612','./icon-192.png?v=1612','./icon-512.png?v=1612'];
