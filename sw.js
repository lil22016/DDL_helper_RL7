const CACHE='deadline-garden-v16-22-liquid-clear-performance';
const ASSETS=['./','./index.html','./styles.css?v=1622','./app.js?v=1622','./manifest.webmanifest','./favicon.ico?v=1612','./apple-touch-icon.png?v=1612','./icon-192.png?v=1612','./icon-512.png?v=1612'];
