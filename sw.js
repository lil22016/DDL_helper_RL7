const CACHE='deadline-garden-v16-16-i18n-display-mobile';
const ASSETS=['./','./index.html','./styles.css?v=1616','./app.js?v=1616','./manifest.webmanifest','./background-keepalive.js','./favicon.ico?v=1612','./apple-touch-icon.png?v=1612','./icon-192.png?v=1612','./icon-512.png?v=1612'];
