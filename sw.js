const CACHE='deadline-garden-v16-30-wallpaper-layer-fix';
const ASSETS=['./','./index.html','./styles.css?v=1630','./app.js?v=1630','./manifest.webmanifest','./favicon.ico?v=1612','./apple-touch-icon.png?v=1612','./icon-192.png?v=1612','./icon-512.png?v=1612'];
