const CACHE='deadline-garden-v16-18-modal-center-task-actions';
const ASSETS=['./','./index.html','./styles.css?v=1618','./app.js?v=1618','./manifest.webmanifest','./background-keepalive.js','./favicon.ico?v=1612','./apple-touch-icon.png?v=1612','./icon-192.png?v=1612','./icon-512.png?v=1612'];
